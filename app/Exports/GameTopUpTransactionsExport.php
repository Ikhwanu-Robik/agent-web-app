...
class GameTopUpTransactionsExport implements FromView, ShouldAutoSize, WithEvents, WithProperties
{
    /**
    ...
    public function view(): View
    {
        return view("report-table", [
            "service" => "game-top-up",
            "reports" => TransactionReport::getReport("game-top-up")
        ]);
    }
